...
//-----------------------------------------------------------------------------
// ALU A-port source selection (alu_src_a, 2-bit)
//-----------------------------------------------------------------------------
// Selects the A operand of the ALU. Generated by decode.v, consumed by
// executor.v. 2-bit to cover LUI's zero operand (v1 used 1 bit: rs1/pc).

`define ALU_A_RS1       2'd0   // A = rs1_data
`define ALU_A_PC        2'd1   // A = pc
`define ALU_A_ZERO      2'd2   // A = 0  (LUI)
